...
//Acá se agregan para agregar mas textuas
uniform sampler2D texture1;
uniform sampler2D texture2;
uniform float porcentajeMe = 0.3f;
...
vec3 calculateDirectionalLight(Light light, vec3 direction){
	...
	vec3 finalColor = mix(textureColor1, textureColor2, porcentajeMe); //Se toma el 70% del primero y el 30% del segundo
